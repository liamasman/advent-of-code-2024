...
.#..^"""
    ...
    expected_grid = [
        [CellType.EMPTY_SPACE, CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
         CellType.EMPTY_SPACE, CellType.EMPTY_SPACE],
        [CellType.SOLID_OBJECT, CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
         CellType.EMPTY_SPACE, CellType.EMPTY_SPACE],
        [CellType.EMPTY_SPACE, CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
         CellType.EMPTY_SPACE, CellType.EMPTY_SPACE]
    ]
...
class TestRunStep:
    class TestDirectionUp:
        def test_step_direction_up_to_empty_space(self):
            grid = [
                [CellType.EMPTY_SPACE, CellType.EMPTY_SPACE,
                 CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
                 CellType.EMPTY_SPACE],
                [CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
                 CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
                 CellType.EMPTY_SPACE],
                [CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
                 CellType.EMPTY_SPACE, CellType.EMPTY_SPACE,
                 CellType.EMPTY_SPACE]
            ]
        ...
        def test_step_direction_up_to_solid_object_three_times_out_of_grid(
            ...
            grid = [
                ...
                [CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
                 CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
                 CellType.EMPTY_SPACE],
                [CellType.SOLID_OBJECT, CellType.SOLID_OBJECT,
                 CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
                 CellType.EMPTY_SPACE]
            ]
            direction = Direction.UP
    ...
    def test_guard_in_loop_returns_true(self):
        grid = [
            [CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
             CellType.SOLID_OBJECT, CellType.EMPTY_SPACE,
             CellType.EMPTY_SPACE],
            [CellType.SOLID_OBJECT, CellType.EMPTY_SPACE, CellType.EMPTY_SPACE,
             CellType.SOLID_OBJECT,
             CellType.EMPTY_SPACE],
            [CellType.EMPTY_SPACE, CellType.EMPTY_SPACE, CellType.SOLID_OBJECT,
             CellType.EMPTY_SPACE,
    ...
    def test_guard_not_in_loop_returns_false(self):
        grid = [
            ...
            [CellType.SOLID_OBJECT, CellType.EMPTY_SPACE, CellType.EMPTY_SPACE,
             CellType.SOLID_OBJECT,
             CellType.EMPTY_SPACE],
            [CellType.EMPTY_SPACE, CellType.EMPTY_SPACE, CellType.EMPTY_SPACE,
             CellType.EMPTY_SPACE,
             CellType.EMPTY_SPACE]
        ]
        position = (1, 1)
